    ...
    <div class="container">
        <div class="row">
            <div class="center-title">
                <h1>GET IN TOUCH</h1>
                <p>
                    Have a project in mind and not sure where to start ? Let's connect and make those ideas come true :)
                </p>
            </div>
            <div class="col-md-12">
                <div class="row">
                    ...
                    <form class="col-md-offset-2 col-md-8 contact-form top_60" method="POST" action="{{ route('contact-me') }}">
                        <div class="row">
                            ...
                            <!-- email -->
                            <div class="col-md-6"><input id="con_email" class="form-input requie" type="email" placeholder="Email"></div>
                            <!--message-->
                            <div class="col-md-12">
